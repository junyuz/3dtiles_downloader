...
def autoDownLoad(url,add):
    ...
    try:
        ...
        opener.addheaders = [('Accept','application/json,*/*;q=0.01,*/*;access_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJjNzYyNmIzMS1lNjJhLTRkMWQtOGQwNi0yNDYzZWRkN2I5ODMiLCJpZCI6NDQsImFzc2V0cyI6eyIxNDYxIjp7InR5cGUiOiIzRFRJTEVTIn19LCJzcmMiOiJiMTBjN2E3Mi03ZGZkLTRhYmItOWEzNC1iOTdjODEzMzM5MzgiLCJpYXQiOjE1NTI2MzA0NjAsImV4cCI6MTU1MjYzNDA2MH0.XH_IJHdKaLkYQgb1RqrEX1TR1A_7GxjbTmVIE0tBShk')]
        #a表示地址， b表示返回头
...
if __name__ == "__main__":
    ...
    #urllib.URLopener.addheader('Accept','application/json,*/*;q=0.01,*/*;access_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJjNzYyNmIzMS1lNjJhLTRkMWQtOGQwNi0yNDYzZWRkN2I5ODMiLCJpZCI6NDQsImFzc2V0cyI6eyIxNDYxIjp7InR5cGUiOiIzRFRJTEVTIn19LCJzcmMiOiJiMTBjN2E3Mi03ZGZkLTRhYmItOWEzNC1iOTdjODEzMzM5MzgiLCJpYXQiOjE1NTI2MzA0NjAsImV4cCI6MTU1MjYzNDA2MH0.XH_IJHdKaLkYQgb1RqrEX1TR1A_7GxjbTmVIE0tBShk')
